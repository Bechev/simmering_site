export function sign_in(email, password, history){
    return (dispatch) => {
        ...
        return fetch("https://simmering.herokuapp.com/api/v1/auth/sign_in" ,{
            method: "POST",
            cache: "no-cache",
...
export function verify_credentials(){
    return(dispatch=>{
        ...
        return fetch("https://simmering.herokuapp.com/api/v1/auth/validate_token", {
            headers:{
                "uid": user.uid,
                "client": user.client,
...
export function sign_out(){
    return(dispatch=>{
        ...
        return fetch("https://simmering.herokuapp.com/api/v1/auth/sign_out", {
        method: 'DELETE',
        headers:{
            "uid": user['uid'],
            "client":  user['client'],
...
export function sign_up( email, username, password, password_confirmation, state,history){
    return (dispatch) => {
        ...
        return fetch("https://simmering.herokuapp.com/api/v1/auth/" ,{
            method: "POST",
            cache: "no-cache",
            credentials: "same-origin",
            headers: {
